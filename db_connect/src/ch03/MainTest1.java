...
public class MainTest1 {
	...
	public static void main(String[] args) {
		...
		// Object는 main 메서드에서 new 하기 때문에 언제 태어나서 언제 지울 수 있는 것을 말하고
		// static 만들어진 녀석들을 프로그램 시작부터 끝까지 존재한다. 
		...
		// 데이터 한 건 조회
		// Statement stmt = connection.createStatement(); 대신 preparedStatement 사용하기
...
//			}
			...
			// insert 한번 하고 또 실행하는 경우 오류나기 때문에 주석처리
