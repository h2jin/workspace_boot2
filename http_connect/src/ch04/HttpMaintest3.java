...
public class HttpMaintest3 {
	...
	public static void main(String[] args) {
		...
		try {
			//Http통신을 하기위한
			// 준비물 1 : 
			URL url = new URL("https://jsonplaceholder.typicode.com/todos"); // 통신을 하기 위해 주소를 만들어주는 클래스.
			// 준비물 2 : 
...
//			System.out.println("statusCode : " + statusCode); // 성공을 의미. 코드
			...
			// ArrayList로 변환하기
			// 파싱처리하기
			Type todoListType = new TypeToken<ArrayList<Todo1>>() {}.getType();
			ArrayList<Todo1> arrayList = new Gson().fromJson(str, todoListType);
